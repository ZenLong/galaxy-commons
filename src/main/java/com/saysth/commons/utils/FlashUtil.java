...
public class FlashUtil
{
    ...
    public static void main(String[] args) {
    	/*String url = "/usr/local/www/lb/horizontal/728x90/201201/e8b26b64-3464-40ba-9737-c20e1518928f.swf";
    	// String str = "lbimg/lsdfasd/sdfa/asdfasd.swf";
    	System.out.println(url+"   url");
    	FlashUtil flashUtil = FlashUtil.getInfo(url);
    	System.out.println(flashUtil.width+"     "+flashUtil.height);
    	System.out.println("size:"+flashUtil.size);
    	//str = str.substring(str.indexOf('/'));
    	//System.out.println(str);*/    	
    	String ext = ".jpg";
    	System.out.println( (69007 > 81920 || (!".jpg".equalsIgnoreCase(ext) && !".gif".equalsIgnoreCase(ext) && !".swf".equalsIgnoreCase(ext))));
	}
     ...
     */
    public static FlashUtil getInfo(String path)
    {
     ...
     * @return      {@link SWFinfo} object or null if file not found or not SWF.
     */
    public static FlashUtil getInfo(File file)
    {
    	FlashUtil     info = new FlashUtil();
