...
/**
 * JobFactory implementation that supports {@link java.lang.Runnable} objects as
...
public class AdaptableJobFactory implements JobFactory {
	 ...
	 * 
	 * @param bundle
	 *            the TriggerFiredBundle from which the JobDetail and other info
	 ...
	 * <p>
	 * The default implementation supports straight Quartz Jobs as well as
	 * Runnables, which get wrapped in a DelegatingJob.
	 * 
	 * @param jobObject
	 *            the original instance of the specified job class
	 * @return the adapted Quartz Job instance
	 * @throws Exception
	 *             if the given job could not be adapted
	 * @see DelegatingJob
	 */
