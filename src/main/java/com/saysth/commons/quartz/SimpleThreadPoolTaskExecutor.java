 ...
 * 
 * <p>
 * Can be shared between a Quartz Scheduler (specified as "taskExecutor") and
 * other TaskExecutor users, or even used completely independent of a Quartz
 * Scheduler (as plain TaskExecutor backend).
 * 
 ...
 */
public class SimpleThreadPoolTaskExecutor extends SimpleThreadPool implements SchedulingTaskExecutor, InitializingBean,
		DisposableBean {

	private boolean waitForJobsToCompleteOnShutdown = false;

	/**
	 * Set whether to wait for running jobs to complete on shutdown. Default is
	 * "false".
	 * 
