...
/**
 * Common base class for accessing a Quartz Scheduler, i.e. for registering
 * jobs, triggers and listeners on a {@link org.quartz.Scheduler} instance.
 * 
 * <p>
...
public abstract class SchedulerAccessor implements ResourceLoaderAware {
	 ...
	 * "job_scheduling_data_1_5" XSD. Can be specified to automatically register
	 * jobs that are defined in such a file, possibly in addition to jobs
	 * defined directly on this SchedulerFactoryBean.
	 * 
	 ...
	 * "job_scheduling_data_1_5" XSD. Can be specified to automatically register
	 * jobs that are defined in such files, possibly in addition to jobs defined
	 * directly on this SchedulerFactoryBean.
	 * 
	 * @see org.quartz.xml.JobSchedulingDataProcessor
	 */
	 ...
	 * <p>
	 * This is not necessary when a Trigger determines the JobDetail itself: In
	 * this case, the JobDetail will be implicitly registered in combination
	 * with the Trigger.
	 * 
	 * @see #setTriggers
	 ...
	 * will be automatically registered with the Scheduler. Else, the respective
	 * JobDetail needs to be registered via the "jobDetails" property of this
	 * FactoryBean.
	 * 
	 * @see #setJobDetails
	 * @see org.quartz.JobDetail
	 ...
	 * explicitly activate them via their name.
	 * 
	...
	protected void registerListeners() throws SchedulerException {
		...
		if (this.globalJobListeners != null) {
			for (JobListener listener : this.globalJobListeners) {
				// listenerManager.addGlobalJobListener(listener);
		...
		if (this.globalTriggerListeners != null) {
			for (TriggerListener listener : this.globalTriggerListeners) {
				// listenerManager.addGlobalTriggerListener(listener);
