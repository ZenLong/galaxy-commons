...
/**
 * Quartz ThreadPool adapter that delegates to a Spring-managed TaskExecutor
...
public class LocalTaskExecutorThreadPool implements ThreadPool {
	...
	public void initialize() throws SchedulerConfigException {
		...
		if (this.taskExecutor == null) {
			throw new SchedulerConfigException(
					"No local TaskExecutor found for configuration - 'taskExecutor' property must be set on SchedulerFactoryBean");
		}
	}
	...
	public int blockForAvailableThreads() {
		...
		// for example calling <code>getMaximumPoolSize() -
		// getActiveCount()</code>
