...
/**
 * Wrapper that adapts from the Quartz {@link ClassLoadHelper} interface onto
 * Spring's {@link ResourceLoader} interface. Used by default when the
 * SchedulerFactoryBean runs in a Spring ApplicationContext.
 * 
