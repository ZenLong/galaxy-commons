...
/**
 * Spring bean-style class for accessing a Quartz Scheduler, i.e. for
 * registering jobs, triggers and listeners on a given
...
public class SchedulerAccessorBean extends SchedulerAccessor implements BeanFactoryAware, InitializingBean {
	...
	/**
	 * Specify the Quartz Scheduler to operate on via its scheduler name in the
	 * Spring application context or also in the Quartz
	 * {@link org.quartz.impl.SchedulerRepository}.
	 * <p>
	 * Schedulers can be registered in the repository through custom
	 * bootstrapping, e.g. via the {@link org.quartz.impl.StdSchedulerFactory}
	 * or {@link org.quartz.impl.DirectSchedulerFactory} factory classes.
	 * However, in general, it's preferable to use Spring's
	 * {@link SchedulerFactoryBean} which includes the job/trigger/listener
	 * capabilities of this accessor as well.
	 */
