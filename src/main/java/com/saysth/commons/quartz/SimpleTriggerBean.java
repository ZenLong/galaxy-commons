 ...
 * 
 * <p>
 * SimpleTrigger itself is already a JavaBean but lacks sensible defaults. This
 ...
 * Quartz {@link org.quartz.SimpleTrigger} class instead.
 * 
 ...
 * @see CronTriggerBean
 */
public class SimpleTriggerBean extends SimpleTriggerImpl implements JobDetailAwareTrigger, BeanNameAware,
		InitializingBean {
	 ...
	 * the {@link org.quartz.SimpleTrigger} class. Default is
	...
	/**
	 * Set the delay before starting the job for the first time. The given
	 * number of milliseconds will be added to the current time to calculate the
	...
	public void afterPropertiesSet() throws ParseException {
		...
		if (this.jobDetail != null) {
			...
			this.setJobDetail(this.jobDetail);
		}
	}
