 ...
 * equivalent of Spring's {@link QuartzJobBean} in the shape of a Quartz 1.5
 * {@link org.quartz.spi.JobFactory}.
 * 
 * <p>
 * Applies scheduler context, job data map and trigger data map entries as bean
 * property values. If no matching bean property is found, the entry is by
 * default simply ignored. This is analogous to QuartzJobBean's behavior.
 * 
...
public class SpringBeanJobFactory extends AdaptableJobFactory implements SchedulerContextAware {
	...
	/**
	 * Specify the unknown properties (not found in the bean) that should be
	 * ignored.
	 * <p>
	 ...
	 * ignored if there is no corresponding property found on the particular job
	...
	/**
	 * Return whether the given job object is eligible for having its bean
	 * properties populated.
	 * <p>
	 * The default implementation ignores {@link QuartzJobBean} instances, which
	 * will inject bean properties themselves.
	 * 
	 * @param jobObject
