...
public class ReflectionUtilsTest {
	...
	public void invokeMethod() {
		TestBean bean = new TestBean();
		assertEquals("hello world", ReflectionUtils.invokeMethod(bean, "privateMethod", new Class[] { String.class },
				new Object[] { "world" }));
	}
	...
	public static class TestBean2 extends ParentBean<Object, Object> {
	}
